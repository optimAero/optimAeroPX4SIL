...
switch lower(vehicleParams.type)
    ...
    case "hexarotor"
        options = sprintf('--fdm=null --native-fdm=socket,in,%d,localhost,5502,udp --aircraft=bigHexy  --aircraft-dir="visualization/c172p " --fog-fastest --disable-clouds --disable-sound', frameRate_Hz);
    otherwise
