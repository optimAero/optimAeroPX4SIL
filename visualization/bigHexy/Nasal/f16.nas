...
var setup_custom_stick_bindings = func {
    ...
    var dlg = gui.Dialog.new("/sim/gui/dialogs/button-axis-config/dialog", "Aircraft/bigHexy/gui/dialogs/button-axis-config.xml", "button-axis-config");
    var dlg = gui.Dialog.new("/sim/gui/dialogs/button-config/dialog", "Aircraft/bigHexy/gui/dialogs/button-config.xml", "button-config");
}
...
return;
var stepNode = io.read_properties("Aircraft/bigHexy/sview/config.xml");#
